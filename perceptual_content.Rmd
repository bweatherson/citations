...
:::{#perception-graph style="float:right; width:60%"}

```{r perception-graph, fig.height=4, fig.width=4.5, fig.cap=cap_text}
jjj <- 127
...
:::{#perception-papers style="clear:both"}
...
cat("<br>**[Full Data](#t-Perceptual-Content)**\n\n")
