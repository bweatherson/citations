...
:::{#mechanisms-graph style="float:right; width:60%"}

```{r mechanisms-graph, fig.height=4, fig.width=4.5, fig.cap=cap_text}
jjj <- 159
...
:::{#mechanisms-papers style="clear:both"}
